...
.container {
  ...
  {.chat-inner{max-width:540px}}
  @media (min-width:768px)
  {.chat-inner{max-width:720px}}
  @media (min-width:992px)
  {.chat-inner{max-width:960px}}
  @media (min-width:1200px)
  {.chat-inner{max-width:1140px}}
  ...
  @media (min-width:576px)
  {.con-input{max-width:540px}}
  @media (min-width:768px)
  {.con-input{max-width:720px}}
  @media (min-width:992px)
  {.con-input{max-width:960px}}
  @media (min-width:1200px)
  {.con-input{max-width:1140px}}
}
</style>
