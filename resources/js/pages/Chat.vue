    ...
    <div class="container">
      ...
      <div class="chat-inner">
        <div class="chat-container">
          <div v-if="getInfos.length === 0" class="chat-no-people">
            暂无消息,赶紧来占个沙发～
          </div>
      ...
      <div class="bottom">
            ...
            <div class="emoji-content" v-show="getEmoji">
              <div class="emoji-tabs">
                <div class="emoji-container" ref="emoji">
                  ...
                  >
                    <span v-for="(item, index) in emoji.people" :key="index">{{
                      item
                    }}</span>
                  </div>
                  <div
                  ...
                  >
                    <span v-for="(item, index) in emoji.nature" :key="index">{{
                      item
                    }}</span>
                  </div>
                  <div
                  ...
                  >
                    <span v-for="(item, index) in emoji.items" :key="index">{{
                      item
                    }}</span>
                  </div>
                  <div
                  ...
                  >
                    <span v-for="(item, index) in emoji.place" :key="index">{{
                      item
                    }}</span>
                  </div>
                  <div
                  ...
                  >
                    <span v-for="(item, index) in emoji.single" :key="index">{{
                      item
                    }}</span>
                  </div>
                </div>
        ...
        <div class="chat">
          ...
          <mu-button class="demo-raised-button" primary @click="submess"
            >发送</mu-button
          >
        </div>
        <input
